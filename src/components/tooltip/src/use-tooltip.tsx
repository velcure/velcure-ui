import {
  ...
  popperCSSVars,
  usePopper,
} from '#/components/popper/src';
import { mergeRefs, useDisclosure, useEventListener } from '#/hooks';
import { PropGetter, callAllHandlers, getScrollParent } from '#/utilities';
import React, {
  useCallback,
  useEffect,
  useId,
...
export function useTooltip(props = {} as UseTooltipProps) {
  const {
    openDelay = 0,
    closeDelay = 0,
    closeOnClick = true,
