...
const GenericAvatar = (props: ComponentPropsWithoutRef<'svg'>) => (
  <svg
    color="#000"
    viewBox="0 0 30 31"
...
export const WithAvatarGroup = () => (
  <div className="flex flex-col gap-6">
    {['xs', 'sm', 'md', 'lg', 'xl'].map((size) => (
      <AvatarGroup size={size as AvatarProps['size']} max={3} key={size}>
...
export const WithCustomIcon = () => (
  <AvatarGroup>
    ...
    <Avatar name="Perry Harris" />
  </AvatarGroup>
);

export const AsEntityIcon = () => (
  <div className="flex flex-row gap-6">
    <Avatar rounded={false} name="teamspiel GmbH" />
    <Avatar rounded={false} name="Velcure GmbH" />
    <Avatar rounded={false} name="Chakra GmbH" />
  </div>
);
