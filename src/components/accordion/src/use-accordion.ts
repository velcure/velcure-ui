import createDescendantContext from '#/components/descendant/src';
import { createContext, useControllableState, useMergeRefs } from '#/hooks';
import { PropGetter } from '#/utilities';
import { callAllHandlers, warn } from '#/utilities/shared-utils';
  ...
  const getButtonProps: PropGetter = useCallback(
    (props = {}, ref) => {
      return {
        ...props,
        type: 'button',
        ref: useMergeRefs(register, buttonRef, ref),
        id: buttonId,
        disabled: !!isDisabled,
