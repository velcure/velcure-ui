...
const PORTAL_CLASSNAME = 'velcure-portal';
const PORTAL_SELECTOR = `.velcure-portal`;

const Container = (props: React.PropsWithChildren<{ zIndex: number }>) => (
  <div
    className="velcure-portal-zIndex"
    style={{
      position: 'absolute',
      zIndex: props.zIndex,
      top: 0,
...
interface ContainerPortalProps extends React.PropsWithChildren<object> {
